...
<h2 align="center">
  <b>
    <span style="line-height: 48px;">CounterScene: Counterfactual Causal Reasoning in Generative World Models for Safety-Critical Closed-Loop Evaluation</span>
    <br/>
  </b>
</h2>
</div>
...
<p>Notes: We will release the full codebase, trained checkpoints, and evaluation scripts upon acceptance of the paper.</p>
